...
def capture_photos(root):
    ...
    #Setting a bg image:
    bg = ImageTk.PhotoImage(image=PIL.Image.open(r"C:\Users\Administrator\Desktop\project_galerry\lock.jpg"))
    ...
    #person_icon
    img1 = Image.open(r"C:\Users\Administrator\Desktop\project_galerry\login.png")
    ...
    name = Label(lbl_frm, bg="black", text="Name", font=("times new roman", 14, "bold"), fg="white")
    name.place(x=40, y=140)

    #Enter name(entry):
    txt_name = Entry(lbl_frm, textvariable = varName, font=("times new roman", 15), fg="black", bg="white")
    txt_name.place(x=120, y=140, width=180,height=25)
    ...
    while True:
        ...
        reqpath = "C:\\Users\\Administrator\\Desktop\\Train\\" + Name + "\\" + "img" + str(pic_no) + '.png'
