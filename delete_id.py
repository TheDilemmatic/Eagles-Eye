...
class Delete_id:
    def __init__(self, root):
        ...
        #image1
        img = Image.open(r"C:\Users\Administrator\Desktop\project_galerry\del0.jpg")
        ...
        #image2
        img1 = Image.open(r"C:\Users\Administrator\Desktop\project_galerry\del2.jpg")
        ...
        #image3
        img2 = Image.open(r"C:\Users\Administrator\Desktop\project_galerry\del3.jpg")
        ...
        #Frame_bg
        fram_bg = Image.open(r"C:\Users\Administrator\Desktop\project_galerry\cap3.jpg")
        ...
        #Delete_button
        change_btn = Button(inner_frame3, bg = "dark red", height = 2, width = 10, text = "Delete", cursor = "hand2", font = ("Times New Roman", 15, "bold"), fg = "white")
        change_btn.grid(row = 2, column = 0, padx = 44, pady = 6)

        #Save_button
        save_btn = Button(inner_frame3, bg = "dark green", height = 2, width = 10, text = "Save", cursor = "hand2", font = ("Times New Roman", 15, "bold"), fg = "white")
